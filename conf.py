# -*- coding: utf-8 -*-
#
# EJBCA-REST documentation build configuration file, created by
...
htmlhelp_basename = 'EJBCA-RESTdoc'
...
latex_documents = [
    (master_doc, 'EJBCA-REST.tex', u'EJBCA-REST Documentation',
...
man_pages = [
    (master_doc, 'EJBCA-REST', u'EJBCA-REST Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EJBCA-REST', u'EJBCA-REST Documentation',
     author, 'EJBCA-REST', 'Certification authority component for dojot platform.',
     'Miscellaneous'),
]
